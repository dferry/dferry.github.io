...
<tr style="background-color:<?php echo $bgColor?>;">
	...
	<th class="due" colspan="4">Final Exam Period</th> 
</tr>
...
<h3><a name="gitinfo"></a>Work Submission</h3>
<p>This course will include coding homework and non-coding homework. All work must be submitted to the appropriate location in order to recieve credit. Any work not submitted correctly (emailed, printed and left under my door, etc.) will not recieve credit.</p>
<p>Any code you create will be submitted through Github. Github is used by software developers to store and share code. You will need to create a Github account if you do not already have one. We will demonstrate the use of Github in class.</p>
<p>Any non coding homework will be submitted through Canvas.</p>
<p>&nbsp;</p>
<hr />
<h3><a name="Textbooks"></a>Textbook and Class Resources</h3>
<p>Required Course Book: <i>The Most Human Human</i> by Brian Christian.</p>
<hr style="width: 100%; height: 2px;" />
...
<p>Grading is done on a straight scale (uncurved). The following scores are guaranteed. The grading scale may be curved upwards (in your favor) at the discretion of the instructor.</p>
<ul>
...
<p>Most work assigned in this course, is expected to be completed individually. The sharing of written work or significant portions of code between students is strictly prohibited.</p>
<hr style="width: 100%; height: 2px;" />
<h2>Attendance</h2>
